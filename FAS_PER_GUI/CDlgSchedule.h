...
// CDlgSchedule form view

class CDlgSchedule : public CDlgDevice
{
	DECLARE_DYNCREATE(CDlgSchedule)

public:
	CDlgSchedule();           // protected constructor used by dynamic creation
	virtual ~CDlgSchedule();
